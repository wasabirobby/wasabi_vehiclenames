...
local resourceName = "wasabi_vehiclenames"

if Config.checkForUpdates then
    CreateThread(function()
        if GetCurrentResourceName() ~= "wasabi_vehiclenames" then
            resourceName = "wasabi_vehiclenames (" .. GetCurrentResourceName() .. ")"
        end
    end)

    CreateThread(function()
        while true do
            PerformHttpRequest("https://api.github.com/repos/wasabirobby/wasabi_vehiclenames/releases/latest", CheckVersion, "GET")
            Wait(3600000)
        end
    end)
    ...
    GetRepoInformations = function()
        ...
        PerformHttpRequest("https://api.github.com/repos/wasabirobby/wasabi_vehiclenames/releases/latest", function(err, response, headers)
            if err == 200 then
                ...
                repoURL = "https://github.com/wasabirobby/wasabi_vehiclenames"
            end
        end, "GET")
